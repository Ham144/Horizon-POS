...
const SalesReport = () => {
	...
	async function handleDownloadRangkingPaymentMethodDetail() {
		...
		link.download = `Statement Horizon POS - filter:: ${selectedOutletObj?.namaOutlet} : ${date} - ${dateRange.startDate}: ${dateRange.endDate}.csv`;
						...
						<div className="grid grid-cols-1 gap-3 mt-2">
							...
							<div className="space-y-2">
								...
								<div className="flex flex-col">
									...
									<span className="font-medium">Horizon Paradigm</span>
								</div>
							</div>
