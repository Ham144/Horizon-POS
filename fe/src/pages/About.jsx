...
export default function About() {
	return (
		<>
			<Helmet>
				<title>Tentang horizon POS - Sistem Manajemen Point of Sale</title>
				<meta
					name="description"
					content="horizon POS adalah sistem manajemen point of sale dari startup yang kurang terkenal dan kurang modal (horizon paradigm) yang terintegrasi dengan aplikasi mobile horizon POS."
				/>
				<meta
					name="keywords"
					content="horizon POS, Point of Sale, POS System, Retail Management, Inventory Management"
				/>
				<meta property="og:title" content="Tentang horizon POS" />
				<meta
					...
					<div className="space-y-12">
						...
						>
							...
							<p className="text-base-content/80 text-lg">
								horizon POS adalah sistem manajemen point of sale buatan Horizon
								Paradigm yang terintegrasi dengan aplikasi mobile horizon POS.
								Sistem ini dirancang untuk mengelola operasi bisnis kasir dengan
								fokus pada:
							</p>
							...
							<div className="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
								<div className="card-body">
									...
									<ul className="list-disc list-inside space-y-2 text-base-content/80">
										...
										<li>Aplikasi mobile horizon POS untuk operasi kasir</li>
									</ul>
								</div>
							</div>
						</section>
								...
								<div className="card-body">
									...
									<ul className="list-disc list-inside space-y-2 mt-4 text-base-content/80">
										<li>
											Email:{" "}
											<a
												href="mailto:yafizham@horizon.co.id"
												className="text-primary hover:underline"
											>
												yafizham@horizon.co.id
											</a>
										</li>
										<li>
											Website:{" "}
